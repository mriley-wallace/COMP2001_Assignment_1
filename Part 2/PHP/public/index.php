...
<!--            <p><a href="#">Link</a></p>-->
        ...
        <div class="col-sm-8 text-left">
            ...
            <h1> Michael's Introduction to Data Sets</h1>
            <p>In this website, I will begin to show you conceptual datasets in a visual format.</p>
            <img src=" ../assets/img/meme.jpg"  class="center" alt="portfolio" width="400" height="487">
            <hr>
            <h3>Introduction</h3>
