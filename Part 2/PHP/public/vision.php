    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="vision.php">Project Vision</a></li>
            </ul>
...
<!--            <p><a href="#">Link</a></p>-->
        ...
        <div class="col-sm-8 text-left">
            ...
            <p>My Project Vision is to show large data in a dataset to be read in a human readable format on a normal HTML page.
            For this, I have chosen the data set of:
                Data showing qualification details and employment status of full-time students in Plymouth in 2011. <i>Source: Office for National Statistics</i> </p>
            <hr>
            <h3>Introduction</h3>
